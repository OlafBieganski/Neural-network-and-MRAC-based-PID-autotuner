...
pid = PIDController(Kp=4.90,Ki=0.03,Kd=10.0) #random settings,  data from the article Kp=4.95,Ki=0.01,Kd=10.02
tunerNN = NNPIDAutotuner(0.9, 0.6, 0.3) # data from paper
